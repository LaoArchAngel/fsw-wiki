...
* Compare branch with FswStg3.FswStg database
* Generate script that will update FswStg3.FswStg database with ONLY YOUR changes
 ...
 * QA approves branch
 * Branch is merged
* Run your script against the FswDev3.Fsw database
